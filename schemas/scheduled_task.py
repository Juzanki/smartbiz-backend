# -*- coding: utf-8 -*-
# Auto-generated placeholder by restore_missing_schemas.py on 2025-08-23T03:25:43.492037+00:00
...
class ScheduledTaskUpdate(BaseModel):
    gift_name: Optional[str] = Field(None, description='Gift display name')
